...
public class fragment_empresas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(empresas != null) {
            ...
            Log.i("sql", "provincias leidas -> " + String.valueOf(this.empresas.size()));
            mRecyclerView = vista.findViewById(R.id.txt_rv_cod_empresa);
            ...
            mRecyclerView.addOnScrollListener(new PaginationListener((LinearLayoutManager) mRecyclerView.getLayoutManager()) {
                ...
                protected void loadMoreItems() {
                    ...
                    if (total_registros_leidos < total_registros) {
                        ...
                        Log.i("sql", "provincias leidas -> " + String.valueOf(this.empresas_leidas));
